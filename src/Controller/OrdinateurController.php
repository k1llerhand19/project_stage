...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #[Route('ordinateur/{id}', name: 'ordinateur.delete', methods: ['DELETE'])]
    public function delete(Ordinateur $ordinateur, EntityManagerInterface $entityManager, Request $request): Response
    {
        if($this->isCsrfTokenValid('delete'.$ordinateur->getId(), $request->get('_token')))
        {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #[Route('ordinateur/{id}', name: 'ordinateur.edit', methods: ['GET', 'POST'])]
