...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #[Route('gpu/{id}', name: 'gpu.delete', methods: ['DELETE'])]
    public function delete(Gpu $gpu, EntityManagerInterface $entityManager, Request $request): Response
    {
        if($this->isCsrfTokenValid('delete'.$gpu->getId(), $request->get('_token')))
        {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #[Route('gpu/{id}', name: 'gpu.edit', methods: ['GET', 'POST'])]
