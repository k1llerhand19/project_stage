...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #[Route('processeur/{id}', name: 'processeur.delete', methods: ['DELETE'])]
    public function delete(Cpu $cpu, EntityManagerInterface $entityManager, Request $request): Response
    {
        if($this->isCsrfTokenValid('delete'.$cpu->getId(), $request->get('_token')))
        {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #[Route('processeur/{id}', name: 'processeur.edit', methods: ['GET', 'POST'])]
